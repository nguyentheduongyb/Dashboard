...
function libraryFunction() {
    window.onload = function () {
        ...
        function sidebarColor(e) {
            for (
                var t, a = e.parentElement.children, n = e.getAttribute('data-color'), i = 0;
                i < a.length;
                i++
            )
                            ...
                            l.querySelector('li:nth-child(' + n + ') .nav-link').onclick = function () {
                                ...
                                if (l.classList.contains('flex-column')) {
                                    ...
                                    (s.style.transform = 'translate3d(' + e + 'px, 0px, 0px)'),
                                        (s.style.width =
                                            l.querySelector('li:nth-child(' + n + ')').offsetWidth + 'px');
                                }
                            };
                        }
                    }),
        ...
        function notify(e) {
            ...
            a.classList.add(
                ...
                (a.innerHTML =
                    '<div className="d-flex mb-1"><div className="alert-icon me-1"><i className="' +
                    e.getAttribute('data-icon') +
                    ' mt-1"></i></div><span className="alert-text"><strong>' +
                    e.getAttribute('data-title') +
                    '</strong></span></div><span className="text-sm">' +
        ...
        function darkMode(e) {
            ...
            if (e.getAttribute('checked')) {
                a.classList.remove('dark-version'),
                    ...
                    S.includes('logo-ct.png') && ((t = S.replace('logo-ct', 'logo-ct-dark')), (L.src = t));
                ...
                for (E = 0; E < h.length; E++)
                    h[E].classList.contains('bg-gray-600') &&
                        (h[E].classList.remove('bg-gray-600'), h[E].classList.add('bg-gray-100'));
                ...
                for (var E = 0; E < f.length; E++)
                    f[E].classList.contains('bg-gray-100') &&
                        (f[E].classList.remove('bg-gray-100'), f[E].classList.add('bg-gray-600'));
                for (var E = 0; E < b.length; E++)
                        ...
                        i = new FullCalendar.Calendar(e, {
                            ...
                            select: function (a) {
                                Swal.fire({
                                    ...
                                    html: '<div className="form-group"><input className="form-control text-default" placeholder="Event Title" id="input-field"></div>',
                                    showCancelButton: !0,
                                    customClass: {
