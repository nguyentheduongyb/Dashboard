...
import user from '~/assets/images/free-user-icon-3296-thumb.png'
...
function Header() {
    ...
    return (
        <nav className="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div className="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li className="breadcrumb-item text-sm text-dark active" aria-current="page">Default
                        </li>
                    </ol>
                ...
                <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul className="navbar-nav  justify-content-end">
                        <li className="nav-item d-flex align-items-center">
                            ...
                            </Link>) : (<div className={cx("avatar")} onClick={() => { setActive(!active); }}>
                                <img className="w-100" src={user} />
                                <ul className={cx("options", active ? "active" : '')}>
                                    <li>
                                        <Link to="/information">Information</Link>
                                    </li>
                                    <li>
                                        <span onClick={handleLogOut} className="cursor-pointer text-danger">Log out</span>
                                    </li>
                                </ul>
                            </div>)}
                                        ...
                                        <div className="d-flex py-1">
                                            ...
                                            <div
                                                ...
                                                <h6
                                                    ...
                                                    <span className="font-weight-bold">New
                                                        message</span>
                                                    from Laur
                                                </h6>
