...
function Sidebar() {
    return (
        <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps--active-y"
            id="sidenav-main">
                ...
                <ul className="navbar-nav">
                    <li className="nav-item">
                        <Link to="/" className="nav-link active" role="button">
                            <div
                                className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                    ...
                    <li className="nav-item">
                        <a data-bs-toggle="collapse" href="#pagesExamples" className="nav-link "
                        ...
                        <div className="collapse " id="pagesExamples">
                            <ul className="nav ms-4 ps-3">
                                <li className="nav-item ">
                                    <Link className="nav-link " to="/page/news">
                                        <span className="sidenav-mini-icon"> N </span>
                                        <span className="sidenav-normal"> News <b
                    ...
                    <li className="nav-item">
                        <a data-bs-toggle="collapse" href="#applicationsExamples" className="nav-link "
                            ...
                            <ul className="nav ms-4 ps-3">
                                ...
                                <li className="nav-item ">
                                    <Link to="/category" className="nav-link ">
                                        ...
                                        <span className="sidenav-normal"> Category </span>
                                    </Link>
                                </li>
                                <li className="nav-item ">
                                    <Link className="nav-link " to="/genre">
                                        <span className="sidenav-mini-icon"> G </span>
                                        <span className="sidenav-normal"> Genre </span>
                                    </Link>
                                </li>
                                <li className="nav-item ">
                                    <Link to="/popular" className="nav-link " >
                                        <span className="sidenav-mini-icon"> P </span>
                                        <span className="sidenav-normal"> Popular </span>
                                    </Link>
                                </li>
                                <li className="nav-item ">
                    ...
                    <li className="nav-item">
                        ...
                        <h6 className="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">DOCS
                        </h6>
                    </li>
                    <li className="nav-item">
                        <a data-bs-toggle="collapse" href="#basicExamples" className="nav-link "
                            ...
                            <ul className="nav ms-4 ps-3">
                                <li className="nav-item ">
                                    <a className="nav-link " data-bs-toggle="collapse"
                                        ...
                                        <span className="sidenav-mini-icon"> G </span>
                                        <span className="sidenav-normal"> Getting Started <b
                                            className="caret"></b></span>
                                    </a>
                                        ...
                                        <ul className="nav nav-sm flex-column">
                                            <li className="nav-item">
                                                <a className="nav-link "
                                                    ...
                                                    target="_blank">
                                                    <span
                                                        className="sidenav-mini-icon text-xs">
                                                        Q </span>
                                ...
                                <li className="nav-item ">
                                    <a className="nav-link " data-bs-toggle="collapse"
                                        ...
                                        <span className="sidenav-normal"> Foundation <b
                                            className="caret"></b></span>
                                    </a>
                    ...
                    <li className="nav-item">
                        <a data-bs-toggle="collapse" href="#componentsExamples" className="nav-link "
                                        ...
                                        <g transform="translate(-1717.000000, -291.000000)"
                                            ...
                                            <g
                                                ...
                                                <g
                                                    ...
                                                    <path className="color-foreground"
                ...
                <div className="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                    ...
                    <div className="card-body text-start p-3 w-100">
                        <div
                            ...
                            <i className="ni ni-diamond text-dark text-gradient text-lg top-0"
            ...
            <div className="ps__rail-y" style={{ top: "0px", height: "682px", right: "0px" }}>
                <div className="ps__thumb-y" tabIndex="0" style={{ top: "0px", height: "457px" }}></div>
            </div>
        </aside>
    );
}
